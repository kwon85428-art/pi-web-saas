...
export default function LoginPage() {
  ...
  const handleWeChatLogin = async () => {
    try {
      ...
      setError('Failed to initiate WeChat login');
    }
  };
